...
public class CustomShield extends Item {
     ...
     */
    public CustomShield(Settings settings, int cooldownTicks, int durability, int enchantability, Item repairItem) {
     ...
     */
    public CustomShield(Settings settings, int cooldownTicks, int durability, int enchantability, Tag.Identified<Item> repairItemTag) {
        super(settings.maxDamage(durability));
     ...
     * @param enchantability - How easily the shield gets good enchantments 9 is the same as an iron tool
     */
    public CustomShield(Settings settings, int cooldownTicks, int durability, int enchantability, Item...repairItems) {
        super(settings.maxDamage(durability));
     ...
     * @param repairItem - Item that can be used to repair the shield.
     */
    public CustomShield(Settings settings, int cooldownTicks, int durability, int enchantability, ShieldEvent event, Item repairItem) {
        super(settings.maxDamage(durability));
     ...
     * @param repairItemTag - Item that can be used to repair the shield.
     */
    public CustomShield(Settings settings, int cooldownTicks, int durability, int enchantability, ShieldEvent event, Tag.Identified<Item> repairItemTag) {
        super(settings.maxDamage(durability));
     ...
     * @param event - Shield event to be registered to the shield item.
     */
    public CustomShield(Settings settings, int cooldownTicks, int durability, int enchantability, ShieldEvent event, Item...repairItems) {
        super(settings.maxDamage(durability));
